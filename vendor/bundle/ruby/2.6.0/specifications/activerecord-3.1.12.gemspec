# -*- encoding: utf-8 -*-
# stub: activerecord 3.1.12 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activemodel>.freeze, ["= 3.1.12"])
      s.add_runtime_dependency(%q<arel>.freeze, ["~> 2.2.3"])
      s.add_runtime_dependency(%q<tzinfo>.freeze, ["~> 0.3.29"])
    else
      s.add_dependency(%q<activesupport>.freeze, ["= 3.1.12"])
      s.add_dependency(%q<activemodel>.freeze, ["= 3.1.12"])
      s.add_dependency(%q<arel>.freeze, ["~> 2.2.3"])
